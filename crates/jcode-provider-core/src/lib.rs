...
pub use anthropic::{
    ANTHROPIC_CLAUDE_CODE_VERSION, ANTHROPIC_OAUTH_BETA_HEADERS, ANTHROPIC_OAUTH_BETA_HEADERS_1M,
    AnthropicContextMode, AnthropicReasoningCaps, anthropic_context_mode, anthropic_effectively_1m,
